...
export const qawlFaslService = {
  ...
  async handleMissingSearchPublishing(userSearch: string) {
    try {
        ...
        console.error("Error handling missing search publishing:", e);
        throw e;
    }
  },
  ...
  mapMainCategory(categoryStr: string): string {
    const CATEGORY_TO_MAIN_CATEGORY: Record<string, string> = {
        "التربية الإيمانية والقيم الروحية": "الإيمان والأسئلة الوجودية",
        "إجابات لم تُسأل بعد": "الإيمان والأسئلة الوجودية",
        "بناء شخصية الطفل وتنمية استقلاليته": "السلوك والتربية",
        "الضبط السلوكي والانضباط النفسي": "السلوك والتربية",
        "الحب والانتماء والتواصل العاطفي داخل الأسرة": "المشاعر والعلاقات",
        "التربية العاطفية والذكاء الوجداني": "المشاعر والعلاقات",
        "التربية والتعليم والتعلم": "التعلم والمدرسة",
        "التربية والتعليم المدرسي والمنهجي": "التعلم والمدرسة",
        "الهوية الرقمية والتربية الإعلامية": "التقنية والإنترنت",
        "التربية الوقائية والوعي بالمخاطر": "الحماية والمخاطر",
        "التربية المستقبلية والابتكار التربوي": "الحياة والهوية",
        "التربية في ظل الأنماط الاقتصادية الجديدة": "الحياة والهوية",
        "التربية في ظل التنقل والثقافات المتعددة": "الحياة والهوية",
        "التربية داخل الأسرة الممتدة والمجتمع": "الحياة والهوية",
        "التربية الاستراتيجية واستشراف المستقبل": "الحياة والهوية"
    };
