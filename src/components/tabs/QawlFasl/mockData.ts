...
export const mockQuestions: QawlFaslQuestion[] = [
  {
    ...
    mainCategory: 'الإيمان والأسئلة الدينية',
  ...
  },
  {
    ...
    category: 'بناء الشخصية والثقة',
    categoryId: 'personality',
    categorySlug: 'personality',
    mainCategory: 'بناء الشخصية والثقة',
  ...
  },
  {
    ...
    category: 'السلوك والتربية والتعامل',
    categoryId: 'behavior',
    categorySlug: 'behavior',
    mainCategory: 'السلوك والتربية والتعامل',
  ...
  },
  {
    ...
    mainCategory: 'الوقاية وحماية الطفل',
  ...
  },
  {
    ...
    mainCategory: 'المشاعر والذكاء العاطفي',
  ...
  },
  {
    ...
    category: 'المستقبل والإستراتيجية',
    categoryId: 'future',
    categorySlug: 'future',
    mainCategory: 'التقنية والإنترنت',
