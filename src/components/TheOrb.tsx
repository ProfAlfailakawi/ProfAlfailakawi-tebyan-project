...
export const TheOrb: React.FC<TheOrbProps> = ({ onTap, onDragUp, language }) => {
  ...
  return (
    ...
    >
      <div className={cn(
        "absolute -top-16 left-0 transition-opacity duration-500 bg-black/90 backdrop-blur-xl text-white px-5 py-2.5 rounded-full shadow-2xl font-black text-[10px] uppercase tracking-[0.2em] border border-white/20 whitespace-nowrap pointer-events-none z-[100] flex items-center justify-center min-w-[120px]",
