        ...
        <div className="p-6 md:p-10 space-y-6 md:space-y-8">
          ...
          <div className="flex flex-col gap-3 mb-2 md:mb-6">
            <button 
              ...
              className="w-full py-3.5 md:py-4 bg-white border border-zinc-200/80 hover:bg-zinc-50 text-zinc-800 rounded-[16px] font-bold shadow-[0_2px_8px_rgba(0,0,0,0.03)] transition-all flex items-center justify-center gap-2 md:gap-3 text-sm md:text-base"
            >
